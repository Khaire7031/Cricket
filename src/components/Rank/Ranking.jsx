                    ...
                    <tbody>
                        {displayedData?.map((player, index) => (
                            <tr key={index} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600">
                                ...
                                <td className="px-2 py-2 cursor-pointer">{player.name}</td>
    ...
    return (
        <div className="container mx-auto px-4 py-4">
            ...
            <div className="flex flex-wrap -mx-4">
                {/* ODI */}
                <TeamRanking url={"teamRanking/1"} />
                {/* Test */}
                {/* <TeamRanking url={"teamRanking/2"} /> */}
                {/* T20 */}
                {/* <TeamRanking url={"teamRanking/3"} /> */}
